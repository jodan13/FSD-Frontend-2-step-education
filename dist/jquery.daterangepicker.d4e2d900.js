...
},{"./bundle-url":"C:/Users/Евгений/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"libs/daterangepicker.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:/Users/Евгений/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"libs/moment.js":[function(require,module,exports) {
var define;
...
},{}],"libs/ru.js":[function(require,module,exports) {
var define;
var global = arguments[3];
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === "object" && typeof module !== "undefined" && typeof require === "function" ? factory(require("../../node_modules/moment")) : typeof define === "function" && define.amd ? define(["../../node_modules/moment"], factory) : factory(global.moment);
...
},{"../../node_modules/moment":"../node_modules/moment/moment.js"}],"C:/Users/Евгений/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"C:/Users/Евгений/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"libs/jquery.daterangepicker.js":[function(require,module,exports) {
var define;
...
(function (factory) {
  ...
  var Mask = function Mask(el, mask, options) {
    var p = {
      ...
      calculateCaretPosition: function calculateCaretPosition(caretPos, newVal) {
        var newValL = newVal.length,
            oValue = el.data("mask-previus-value") || "",
            oValueL = oValue.length; // edge cases when erasing digits

        if (el.data("mask-keycode") === 8 && oValue !== newVal) {
          caretPos = caretPos - (newVal.slice(0, caretPos).length - oValue.slice(0, caretPos).length); // edge cases when typing new digits
  ...
  $.fn.dateRangePicker = function (opt) {
    ...
    if (opt.singleMonth) opt.stickyMonths = false; // if (!opt.showTopbar) opt.autoClose = false; // true
      ...
      if (day.hasClass("has-tooltip") && day.attr("data-tooltip")) {
        ...
        if (opt.singleDate) {
          ...
          box.find(".day").each(function () {
            ...
            if (hoverTime < opt.start && !opt.end) {
              box.find(".first-date-selected").addClass("left");
            } else {
              box.find(".first-date-selected").removeClass("left");
            }
          });
    ...
    function createDom() {
      ...
      html += '<div class="month-wrapper">' + '   <table class="month1" cellspacing="0" border="0" cellpadding="0">' + "       <thead>" + '           <tr class="caption">' + "               <th>" + '                   <span class="material-icons prev">' + arrowPrev + "                   </span>" + "               </th>" + '               <th colspan="' + _colspan + '" class="month-name">' + "               </th>" + "               <th>" + (opt.singleDate || !opt.stickyMonths ? '<span class="material-icons next">' + arrowNext + "</span>" : "") + "               </th>" + "           </tr>" + '           <tr class="week-name">' + getWeekHead() + "       </thead>" + "       <tbody></tbody>" + "   </table>";
      ...
      if (opt.showCustomValues) {
        ...
        if (opt.customValues) {
          for (var i = 0; i < opt.customValues.length; i++) {
            ...
            html += "<button class=\"button-" + val.value + "\" id=\"" + val.value + "\">" + val.name + "</button>"; //  '&nbsp;<span class="custom-value"><a href="javascript:;" custom="' + val.value + '">' + val.name + "</a></span>";
          }
        }
      }
  ...
  $("#date-two-inputs").dateRangePicker({
    ...
    separator: " ",
    getValue: function getValue() {
      if ($("#date-range-two1").val() && $("#date-range-two2").val()) return $("#date-range-two1").val() + " " + $("#date-range-two2").val();else return "";
    },
...
},{"./daterangepicker.scss":"libs/daterangepicker.scss","./moment.js":"libs/moment.js","./ru.js":"libs/ru.js","jquery":"../node_modules/jquery/dist/jquery.js","moment":"../node_modules/moment/moment.js"}],"C:/Users/Евгений/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/Евгений/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","libs/jquery.daterangepicker.js"], null)
//# sourceMappingURL=/jquery.daterangepicker.d4e2d900.js.map